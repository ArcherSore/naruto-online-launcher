 ...
 *   - Future safe event sources may call auditor.recordEvent(type)
...
function create(profileId, opts) {
  ...
  function _loadInitialState() {
    ...
    try {
      ...
      merged.eventsTriggered = Object.assign(
        defaultState.eventsTriggered,
        loaded.eventsTriggered || {}
      );
      merged.stallsDetected = Object.assign(
        defaultState.stallsDetected,
        loaded.stallsDetected || {}
      );
  ...
  function getSummary() {
    ...
    return {
      ...
      totalEvents:
        _state.eventsTriggered.exp +
        _state.eventsTriggered.pvp +
        _state.eventsTriggered.war +
        _state.eventsTriggered.other,
